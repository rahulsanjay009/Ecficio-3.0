  ...
  function srcAppServicesStorageServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(StorageService, [{
        key: "addItem",
        value: function addItem(item, ITEMS_KEY) {
          var _this = this;
        ...
        key: "addItems",
        value: function addItems(item, ITEMS_KEY) {
          var _this2 = this;
        ...
        key: "getItems",
        value: function getItems(ITEMS_KEY) {
          return this.storage.get(ITEMS_KEY);
        }
      }, {
        key: "updateItem",
        value: function updateItem(item, ITEMS_KEY) {
          var _this3 = this;
          ...
          return this.storage.get(ITEMS_KEY).then(function (items) {
            ...
            return _this3.storage.set(ITEMS_KEY, newItems);
          });
        }
      }, {
        key: "deleteItem",
        value: function deleteItem(item, ITEMS_KEY) {
          var _this4 = this;
          ...
          return this.storage.get(ITEMS_KEY).then(function (items) {
            ...
            return _this4.storage.set(ITEMS_KEY, newItems);
          });
        }
      }, {
        key: "getAuth",
        ...
        key: "setEvent",
        value: function setEvent(x) {
          return this.storage.set(event_key, x);
        }
      }, {
        key: "setqr",
        value: function setqr(x) {
          return this.storage.set(event_key, x);
        }
      }]);
